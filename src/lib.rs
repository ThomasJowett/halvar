...
impl CameraUniform {
    ...
    fn update_view_projection(&mut self, camera: &Camera) {
        self.view_projection = camera.build_view_perspective_matrix().into();
    }
}
...
impl State {
    async fn new(window: Window) -> Self {
        ...
        let diffuse_bytes = include_bytes!("../res/flower_painting.png");
        let diffuse_texture =
            texture::Texture::from_bytes(&device, &queue, diffuse_bytes, "flower_painting.png")
                .unwrap();
